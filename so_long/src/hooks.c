...
int	ft_input(int key, void *param)
{
	...
	if (key == 124 || key == 2)
		program->player_sprite.sprite_position.x += program->player_sprite.sprite.size.x;
	else if (key == 123 || key == 0)
		program->player_sprite.sprite_position.x -= program->player_sprite.sprite.size.x;
	else if (key == 125 || key == 1)
		program->player_sprite.sprite_position.y += program->player_sprite.sprite.size.y;
	...
	mlx_put_image_to_window(program->mlx, program->window.reference,
		program->player_sprite.sprite.reference, program->player_sprite.sprite_position.x, program->player_sprite.sprite_position.y);
...
int	ft_update (void *param)
{
	...
	if (frame == ANIMATION_FRAMES)
		program->player_sprite.sprite_position.y += 1;
